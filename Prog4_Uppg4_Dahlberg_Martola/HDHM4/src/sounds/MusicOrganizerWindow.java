...
public class MusicOrganizerWindow extends JFrame {
		...
		tree.addMouseListener(new MouseInputAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 1){
					if (getSelectedAlbum() == controller.getBestAlbum() || getSelectedAlbum() == controller.getFlaggedAlbum())
						buttonPanel.changeEnable(false);
						
					else
						buttonPanel.changeEnable(true);
	...
	public void onClipsUpdatedNull(){
		Album a = controller.getRootAlbum();
		clipTable.display(a);
		
	}

	public int promptForRatingSound() {
		
		 String[] data = {"0","1","2","3","4","5"};
	     
	     return (int) JOptionPane.showOptionDialog(
	        clipTable,
	        "Rate Sound from 0-5: ",
	        "Rate Sound",
